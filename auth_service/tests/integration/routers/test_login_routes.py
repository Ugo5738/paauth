...
from tests.utils import create_mock_supa_user, create_mock_supa_session # Absolute import from project root
from auth_service.schemas.user_schemas import UserLoginRequest, MagicLinkLoginRequest, MagicLinkSentResponse, SupabaseSession
